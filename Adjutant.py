...
def process_text(inp,mode): #function to interact with Adjutant and also to determine other functions
    try:
        if "who are you" in inp:
            ...
            assistant_speaks(speak)
            return
        elif 'hello' in inp or 'hey' in inp or 'hi' in inp:
            ...
            edu_search(mode)
            return
        elif 'sick' in inp or 'doctor' in inp or 'hospital' in inp or 'emergency' in inp or 'ill' in inp or 'appointment' in inp: 
            webbrowser.open('https://www.kghospital.com/telehealth.html')
            return
        elif 'consult' in inp or 'solution' in inp or 'service' or 'software' in inp or 'application' in inp:
        ...
        print(e)
        assistant_speaks("I don't understand, maybe I can search the web for you, Do you want to continue?")
        ans = get_audio()
